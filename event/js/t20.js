...
sv:{list_sv:"anc.mb,anc.em,anc.cp,youtube.com,anc.net,anc.jw,anc.fw,anc.js,anc.vjs,anc.kal,anc.cri,anc.ban,anc.ov,anc.ply,anc.mpd,anc.gdt,anc.site,anc.tof",
ten_sv:"MOBILE:,EM:,CP:,YT:,NET:,JW:,FW:,JS:,VJS:,KAL:,CRI:,BAN:,OVN:,PLY:,MPD:,GDTV:,Site:,TOFFE:"}};
